...
public class CSVIteratorTestSimple extends TestCase {
	...
	public void setUp() throws Exception{
		super.setUp();
		list						= new CSVArrayList("target/test-classes/simple.csv");
		...
		line1.put("header1", "value11");
		line1.put("header2", "value12");
		line2.put("header1", "value21");
		line2.put("header2", "value22");
